            ...
            db.collection('economy').doc(uzivatel).get().then((d) => {
                ...
                db.collection('statusy').doc('status').get().then((q) => {
                    ...
                    if(status === 'off'){                                                           //OFF
                        ...
                        embed.addField(`${message.author.tag}`, `stavil: ${args[1]}, celkom stavených: ${args[1]}`);
                        
                        let embedik = new MessageEmbed();
                        ...
                        db.collection('jackpot').doc(message.member.user.id).get().then((k) => {
                            if(k.exists){
                                ...
                                embed.setColor("#9032df");
                                embed.setTitle("Jackpot stávka");
                                embed.addField(`${message.author.tag}`, `stavil: ${args[1]}, celkom stavených ${suma}`);
                                ...
                                db.collection('statusy').doc('status').get().then((ono) => {
                                    ...
                                    embed1.addField(`${message.author.tag}`, `stavil: ${args[1]}, celkom stavených ${args[1]}`);

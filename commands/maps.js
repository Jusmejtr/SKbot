module.exports = {
    ...
    execute(message, config){
        ...
        //active
        function MapA() {
            let map_a = ["Mirage", "Inferno", "Ancient", "Nuke", "Overpass", "Anubis", "Vertigo"];
        ...
        //wm
        function MapWM() {
            let map_wm = ["Vertigo", "Train", "Shortdust", "Overpass", "Lake", "Inferno", "Cobblestone", "Nuke", "Boyard", "Chalice"];
        ...
        //mm
        function MapMM() {
        let map_mm = ["Mirage", "Inferno", "Overpass", "Vertigo", "Nuke", "Ancient", "Dust II", "Train", "Cache", "Agency", "Office", "Tuscan", "Anubis"];

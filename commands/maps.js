module.exports = {
    ...
    execute(message, config){
        ...
        //active
        function MapA() {
            let map_a = ["Mirage", "Inferno", "Ancient", "Nuke", "Overpass", "Dust II", "Vertigo"];
        ...
        //wm
        function MapWM() {
            let map_wm = ["Vertigo", "Train", "Shortdust", "Overpass", "Lake", "Inferno", "Cobblestone", "Nuke", "Hive", "Crete"];
        ...
        //mm
        function MapMM() {
        let map_mm = ["Mirage", "Inferno", "Train", "Nuke", "Overpass", "Dust II", "Vertigo", "Cache", "Office", "Agency", "Ancient", "Iris", "Climb"];
